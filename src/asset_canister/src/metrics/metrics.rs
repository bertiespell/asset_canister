use crate::api::canister::CanisterInfo;

pub fn collect_metrics() -> CanisterInfo {
    let heap_memory_size = get_heap_memory_size();
    let memory_size = get_stable_memory_size() + heap_memory_size;
